...
line([2050,2050],[24,28.5],'Color',[0.9 0.9 0.9]);
line([2100,2100],[24,28.5],'Color',[0.9 0.9 0.9]);
line([2150,2150],[24,28.5],'Color',[0.9 0.9 0.9]);
line([2200,2200],[24,28.5],'Color',[0.9 0.9 0.9]);
line([2250,2250],[24,28.5],'Color',[0.9 0.9 0.9]);
...
set(gca,'Fontsize',16,'XLim',[2040 2260],'YLim',[24.8 26.8],'Fontname','Times New Roman')
xticks([ ])
yticks([26 26.8])
box on
grid on
...
set(gca,'Fontsize',16,'XLim',[2040 2260],'YLim',[26.8 28.3],'Fontname','Times New Roman')
...
% print(gcf,'-dtiff','-r300','F2c_DIC_density.tif'); 
