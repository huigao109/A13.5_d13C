...
load('D:\carbon\carbon_study\South Atlantic\GLOPADv2_2019\A13.5_2010.mat')
...
innn=find(sdep<=1000);
dept=sdep(innn);
sd13Cant=d13C_eMLR(innn);
md13Cant=nanmean(sd13Cant);

figure
plot(dept,sd13Cant,'k.')
...
% print(gcf,'-dtiff','-r300','eMLR_d13C_change_include_50m_all'); 
